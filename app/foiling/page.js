        ...
        <div className={`container ${styles.infoGrid}`}>
          ...
          <div className={styles.detailsCard}>
            ...
            {[
              ...
              { svg: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>, label: 'Pricing', value: 'From $530 (2 hrs) · $795 (3) · $1,060 (4)' },
            ].map((d) => (
