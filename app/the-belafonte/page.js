      ...
      <section className={`section ${styles.info}`}>
        <div className={`container ${styles.infoGrid}`}>
          ...
          <div className={styles.detailsCard}>
            ...
            <a href="https://fareharbor.com/embeds/book/boatcharterssb/?full-items=yes" target="_blank" rel="noopener noreferrer" className={`btn btn--primary ${styles.bookingCTA}`}>Book Your Charter</a>
          </div>
        </div>
      </section>
