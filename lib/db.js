...
// Return `date` columns (tours.season_start / season_end) as 'YYYY-MM-DD'
// strings. pg's default parses them into a JS Date at local midnight, which
// shifts a season boundary by a day on any server not running in Pacific time.
